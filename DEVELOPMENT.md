...
```bash
git remote add encore encore://liberated-prevention-app-qud2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/liberated-prevention-app-qud2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/liberated-prevention-app-qud2/settings/integrations/github)

...
export function Flow() {
  ...
  const getPositionClasses = (position: string) => {
    switch (position) {
      ...
      case 'right':
        return 'absolute top-1/2 right-12 transform -translate-y-1/2';
      case 'bottom-right':
        return 'absolute bottom-12 right-20';
      case 'left':
        return 'absolute top-1/2 left-12 transform -translate-y-1/2';
      case 'bottom-left':
        return 'absolute bottom-12 left-20';
      default:
        return '';
    }
  };
      ...
      <div className="relative bg-gradient-to-br from-indigo-50 to-teal-50 p-8 rounded-2xl min-h-96">
        <div className="relative h-80">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 1 }}>
            {/* Top connection */}
            <line x1="50%" y1="50%" x2="50%" y2="25%" stroke="#94A3B8" strokeWidth="2" strokeDasharray="5,5" />
            {/* Right connection */}
            <line x1="50%" y1="50%" x2="75%" y2="50%" stroke="#94A3B8" strokeWidth="2" strokeDasharray="5,5" />
            {/* Bottom-right connection */}
            <line x1="50%" y1="50%" x2="70%" y2="70%" stroke="#94A3B8" strokeWidth="2" strokeDasharray="5,5" />
            {/* Left connection */}
            <line x1="50%" y1="50%" x2="25%" y2="50%" stroke="#94A3B8" strokeWidth="2" strokeDasharray="5,5" />
            {/* Bottom-left connection */}
            <line x1="50%" y1="50%" x2="30%" y2="70%" stroke="#94A3B8" strokeWidth="2" strokeDasharray="5,5" />
          </svg>
        </div>
      </div>
